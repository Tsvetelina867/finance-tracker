  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const budgetData = {
        ...
        currentSpending: parseFloat(formData.currentSpending) || 0,
        description: formData.description,
        account: { id: currentAccount.id },
      };

      console.log("Submitting budgetData:", budgetData);
            ...
            {budgets.map((budget) => (
              <li key={budget.id} className="budget-item">
                <div className="budget-details">
                  ...
                  <div>
                    <em>{budget.category?.name}</em> | Budget Limit: $
                    {budget.budgetLimit} | Current Spending: $
                  ...
                  <div className="progress-bar">
                    <div
                      className="progress"
                      style={{
                        width: `${calculateProgress(budget.budgetLimit, budget.currentSpending)}%`,
                      }}
                    ></div>
                  </div>
